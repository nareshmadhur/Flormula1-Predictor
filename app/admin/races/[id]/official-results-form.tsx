  ...
  return (
    <form action={action} className="space-y-6">
      ...
      {bonusQuestions.length > 0 && (
        <div className="space-y-4 rounded-xl border border-white/5 bg-black/30 p-4">
          <h3 className="text-sm font-bold uppercase text-slate-300">Bonus Answers</h3>
      ...
      <FormActionButton idleLabel="Save official results" pendingLabel="Saving official results..." tone="primary" />
    </form>
  )
}
